pfUI:RegisterModule("firstrun", "vanilla:tbc", function ()
  ...
  pfUI.firstrun:AddStep("profile", function()
    ...
    f.Modern:SetPoint("BOTTOM", -65, 80)
    ...
    f.Legacy:SetPoint("BOTTOM", 65, 80)
    ...
    f.test = CreateFrame("Button", nil, f, "UIPanelButtonTemplate")
    f.test:SetWidth(120)
    f.test:SetHeight(20)
    f.test:SetPoint("BOTTOM", 65, 30)
    f.test:SetTextColor(1,1,1)
    f.test:SetText("test")
    f.test:SetScript("OnClick", function()
      _G["pfUI_config"] = CopyTable(pfUI_profiles["test"])
      pfUI:LoadConfig()
      ReloadUI()
    end)
    SkinButton(f.test)

    f.minimal = CreateFrame("Button", nil, f, "UIPanelButtonTemplate")
    f.minimal:SetWidth(120)
    f.minimal:SetHeight(20)
    f.minimal:SetPoint("BOTTOM", -65, 30)
    f.minimal:SetTextColor(1,1,1)
    f.minimal:SetText("minimal")
    f.minimal:SetScript("OnClick", function()
      _G["pfUI_config"] = CopyTable(pfUI_profiles["minimal"])
      pfUI:LoadConfig()
      ReloadUI()
    end)
    SkinButton(f.minimal)
